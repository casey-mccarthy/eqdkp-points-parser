...
def main():
    ...
    # Get the API key, either from the .env file or prompt the user
    get_api_key()
    ...
    while True:
        console.print("[bold yellow]Options:[/bold yellow] [cyan]character <name>[/cyan] or [cyan]c <name>[/cyan], [cyan]top <number>[/cyan] or [cyan]t <number>[/cyan], [cyan]exit[/cyan]")
